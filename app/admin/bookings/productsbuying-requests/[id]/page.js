            ...
            <div className="relative space-y-6">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className={`w-full py-3 flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-xl transition-all shadow-lg ${updating || newStatus === enquiry.status ? "opacity-80 cursor-not-allowed" : "hover:from-blue-500 hover:to-purple-500 shadow-blue-500/40"}`}
                >
